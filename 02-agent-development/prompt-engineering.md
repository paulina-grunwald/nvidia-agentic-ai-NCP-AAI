...
## Prompt Tuning and P-Tuning (PEFT Methods)
...
**Mechanism:** Uses an intermediate model (LSTM or MLP) called a **prompt encoder** to *predict* virtual token embeddings, rather than learning them directly.
